...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 97662c7e-1339-47f4-9b9d-fe3f54e3cee4
```

> `97662c7e-1339-47f4-9b9d-fe3f54e3cee4` is the password of the certificate, you can change it to any password you want.
